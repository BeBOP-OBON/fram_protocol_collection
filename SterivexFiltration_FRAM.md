...
No additional safety rules required for you safety. Just avoid contamination of the samples by wearing gloves.

## Training requirements

To guarantee an easy and smooth liquid flow through the filter and to make sure not to brake the high flow peristaltic pump you should be introduced how to make a proper set-up with the filtering device.

## Time needed to execute the procedure

The time depends on the kind of sample (deep sea or surface water; arctic or tropical water etc.) and the volume you want to filter. You can calculate 1-2 hours for getting the water from the CTD, set-up the filtering system and filter around 10 L.
...
| ------------- | ------------- | ------------- | ------------- | ------------- |
| **Durable equipment** |
| Peristal tic pump drive unit | Gilson MP3 Drive Unit 0.01 to 48 RP, 110/220 V (order number: F155001) | Content Cell | 1 | Content Cell |
| High fliw pump head | Gilson Pump Head, R4HF Four Channel, High flow (order number: F117831) | Content Cell | 1 | Content Cell |
| Tubing for pump head | Gilson Tuning, PVC, 8mm x 11.3 m | Content Cell | 4 (one for each pump head channel | food safe! Rinse before use |
| tube conntectors |  | various | |
| tubin to connect pump tubin with Sterivex |  | various | food safe!; rinse before use |
| 5ml- tube- box | | | | To store the Sterivex filters |
| big / heavy screw |  |  | 1 | fixed with tape on the tubing to weight it down in the canister; STAINLESS! |
| waterproof tape | | | | for fastening the screw; best is electrical tape |
| **Consumable equipment** |
| Sterive x flter with luer-lock | Content Cell | Content Cell | 1 | Content Cell |
| luer- lock stopper s (or parafilm) | Content Cell | Content Cell | 2 | to seal the Sterivex |
| 10 or 20ml syringe with luer-lock | | | 1 | sterile; to flush out the rest water from Sterivex |
| **Chemicals** |
